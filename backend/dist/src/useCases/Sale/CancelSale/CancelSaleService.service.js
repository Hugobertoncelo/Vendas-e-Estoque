...
exports.CancelSaleService = void 0;
const tsyringe_1 = require("tsyringe");
let CancelSaleService = class CancelSaleService {
    constructor(salesRepository) {
        this.salesRepository = salesRepository;
    }
    async execute(idSale) {
        const filters = {
            _id: idSale,
        };
        const updateFields = {
...
exports.CancelSaleService = CancelSaleService = __decorate([
