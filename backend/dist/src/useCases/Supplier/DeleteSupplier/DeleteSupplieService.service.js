...
let DeleteSupplierService = class DeleteSupplierService {
    constructor(suppliersRepository) {
        this.suppliersRepository = suppliersRepository;
    }
    async execute(supplierId) {
        if (!supplierId)
            throw new AppError_1.AppError('_id do fornecedor não informado');
        await this.suppliersRepository.delete(supplierId);
    }
};
exports.DeleteSupplierService = DeleteSupplierService;
exports.DeleteSupplierService = DeleteSupplierService = __decorate([
